      ...
      groups: [
        {
          ...
          fields: [
            ...
            { key: "price_rs", label: "Price in Rs", type: "text", placeholder: "Calculated automatically", highlight: true },
        ...
        },
        {
          ...
          fields: [
            ...
            { key: "storage", label: "Storage", type: "text", unit: "GB", placeholder: "e.g. 256GB" },
        ...
        },
        {
          ...
          fields: [
            { key: "battery_capacity", label: "Battery Capacity", type: "select", options: ["6500 mAh", "5000 mAh"], highlight: true, placeholder: "6500 mAh" },
        ...
        },
        {
          ...
          icon: "ph-cpu",
          fields: [
            { key: "chipset", label: "Chipset", type: "select", options: ["Mediatek Dimensity 8500 Ultra", "Google Tensor G5 (3 nm)"], highlight: true, placeholder: "Mediatek Dimensity 8500 Ultra" },
        ...
        },
        {
          ...
          fields: [
            ...
            { key: "refresh_rate", label: "Refresh Rate", type: "select", options: ["120Hz"], placeholder: "e.g. 120Hz" },
          ],
        },
        {
          name: "Camera Details",
          ...
          fields: [
            ...
            { key: "selfie_camera_video", label: "Selfie Camera Video", type: "text", placeholder: "e.g. 1080p@30fps" },

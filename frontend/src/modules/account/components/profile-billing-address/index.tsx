...
const ProfileBillingAddress: React.FC<MyInformationProps> = ({
  ...
  // Single-address mode: this editor manages the customer's one and
  // only address, so it must be the default for BOTH billing AND
  // shipping. Without `isDefaultShipping: true` Medusa would treat
  // the saved address as a billing-only record and the checkout flow
  // wouldn't auto-pre-fill the delivery form.

      ...
      <ul className="flex flex-col gap-1.5 small:gap-2 py-2 small:py-3">
        ...
        <li className="relative px-1.5 small:px-2">
          ...
          >
            ...
            <span className="text-[9px] small:text-[12.5px] leading-tight font-semibold text-black group-hover:text-primary break-words max-w-[54px] small:max-w-[76px] transition-colors">
              Shop All
            </span>
          </LocalizedClientLink>
        </li>

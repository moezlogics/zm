...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source: "/:country([a-z]{2})/terms",
        destination: "/:country/terms-conditions/",
        permanent: true,
      },
      {
        source: "/contact",
      ...
      {
        source: "/:country([a-z]{2})/contact",
        destination: "/:country/contact-us/",
        permanent: true,
      },
      {
        source: "/about",
      ...
      {
        source: "/:country([a-z]{2})/about",
        destination: "/:country/about-us/",
        permanent: true,
      },
      {
        source: "/privacy",
      ...
      {
        source: "/:country([a-z]{2})/privacy",
        destination: "/:country/privacy-policy/",
        permanent: true,
      },
    ]
  },
